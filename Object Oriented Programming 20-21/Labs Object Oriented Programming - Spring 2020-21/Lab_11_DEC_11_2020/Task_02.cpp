...
class Company{
    ...
    Department D1,D2;
    public:
    Company(string Name):D1("Production",20),D2("Finance",10){
        this->company_name=Name;
        total_employees=0;
    }
    void add_employee(int Department,int type){
        int salary,hours,hours_rate;
            ...
            switch(type){
                    ...
                    cout<<'\n'<<"Regular Employee\n";
                    if(Department==1)
                    D1.add_employee(hours,salary,randsname(),randfname());
                    if(Department==2)
                    D2.add_employee(hours,salary,randsname(),randfname());
                    break;
                    
                    case 2:
                    cout<<'\n'<<"Contractual Employee\n";
                    if(Department==1)
                    D1.add_employee(hours_rate,hours,salary,randsname(),randfname());
                    if(Department==2)
                    D2.add_employee(hours_rate,hours,salary,randsname(),randfname());
                    break;
                    ...
                    if(Department==1)
                    D1.add_employee(hours_rate,hours,randsname(),randfname());
                    if(Department==2)
                    D2.add_employee(hours_rate,hours,randsname(),randfname());
                    break;
            }
        total_employees++;
    }
    ...
    Department get_Department(int i=1){
        if(i==1)
        return D1;
        if(i==2)
        return D2;
...
{   int i;
    out << "Company Name :"<<c.get_company_name()<<"\n"; 
    out << "Department #01\n\n";
    cout<<c.get_Department();
    out <<"\n\n"; 
    out << "Department #02\n\n"; 
    cout<<c.get_Department(2);
    out<<"\n\n";
    return out; 
};
...
int main(){ 
    Company c("OMEGA Corp Pvt Ltd.");
    int i;
    srand(time(0));

    for(i=1;i<=20;i++)
    c.add_employee(1,(rand()%3)+1);
    //Randomly genereted 20 members in 2nd department
    
    for(i=1;i<=10;i++)
    c.add_employee(2,(rand()%3)+1);
    //Randomly genereted 10 members in 2nd department
