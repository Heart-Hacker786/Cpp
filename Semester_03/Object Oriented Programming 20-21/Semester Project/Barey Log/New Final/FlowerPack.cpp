...
int main(){
	...
	file1.close();
    	...
    	Florist ft[5];
        //ifstream file;
        fstream file("florist.bin",ios::binary | ios::out | ios::in | ios::app);
    ...
    do{
        ...
        case 1:
            cout<<"\n\t\tBlossom House\n";
            file.read((char*)&ft,sizeof(Florist)*10);
            for(int i=0;i<5;i++)
                cout<<ft[i];
            cout<<"\n\n";
            break;
        ...
        case 3:
            cin>>f2;
            file.write((char*)&f2,sizeof(Florist));
            break;
        case 4:
	    cin>>name;
	    for(int i=0; i<5;i++){
	    if(ft[i].order_taker==name)
	    	cout<<ft[i];
	    }
            break;
